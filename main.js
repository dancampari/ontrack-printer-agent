...
// Escuta mudanças de tema do SO para atualizar ícones do menu nativo (claro ↔ escuro).
...
function createTray() {
    ...
    // Menu nativo do Windows (mesmo padrão do Docker Desktop / OneDrive).
    // Click esquerdo + direito mostram o menu nativo (Windows controla
    // posicionamento, foco e dismiss). Duplo-clique abre o painel.
    ...
    updateTrayMenu(); // popula tray.setContextMenu (menu nativo)
}
...
function updateTrayMenu() {
    ...
    // Menu nativo do Windows — quem controla posição, foco e dismiss é o SO.
    // Padrão idêntico ao Docker Desktop / OneDrive / qualquer app sério.
